...
- Le mode multijoueur local repose sur `state.mode` et `state.players`; les champs solo (`snake`, `direction`, `directionQueue`, `score`) restent des alias du joueur 1 et du score total pour compatibilite.

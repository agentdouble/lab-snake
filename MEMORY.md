...
- Le menu de reglages est gere par `src/settings-menu.js`; les preferences UI persistantes passent par `snake.settings` dans `localStorage` via `loadSettings`/`saveSettings` dans `src/storage.js`.

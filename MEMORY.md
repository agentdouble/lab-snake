...
- Le choix de couleur du serpent est centralise dans `src/snake-colors.js`, persiste via `snake.color` quand l'option "Garder pour Rejouer" est active, et `Rejouer` revient au vert par defaut quand cette option est desactivee.
